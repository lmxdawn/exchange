package com.lmxdawn.market.aspect;

import com.lmxdawn.market.annotation.LoginAuthAnnotation;
import com.lmxdawn.market.enums.ResultEnum;
import com.lmxdawn.market.exception.JsonException;
import com.lmxdawn.market.util.JwtUtils;
...
public class LoginAuthorizeAspect {
    ...
    @Pointcut("@annotation(com.lmxdawn.market.annotation.LoginAuthAnnotation)")
